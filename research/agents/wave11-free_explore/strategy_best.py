...
class Strategy:
    ...
    def __init__(self, config: dict | None = None):
        ...
        self.spread_frac = float(cfg.get("spread_frac", 0.6366234383918591))
        # Inventory skew strength (price shift per share of net YES exposure) — stronger
        self.skew_bps_per_share = float(cfg.get("skew_bps_per_share", 0.393268576797835))
        ...
        self.inv_soft_cap = float(cfg.get("inv_soft_cap", 70.0))
        ...
        self.pull_size_mult = float(cfg.get("pull_size_mult", 0.5082540335883512))
