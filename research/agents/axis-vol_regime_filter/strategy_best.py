...
class Strategy:
    ...
    def __init__(self, config: dict | None = None):
        ...
        self.spread_frac = float(cfg.get("spread_frac", 0.82))
        ...
        self.size_mult = float(cfg.get("size_mult", 1.05))
        ...
        self.min_daily_reward_pool = float(cfg.get("min_daily_reward_pool", 400.0))
        ...
        self.vol_filter = float(cfg.get("vol_filter", 0.01))  # price units; 0=off
        self.vol_lookback = int(cfg.get("vol_lookback", 3))
