...
class Strategy:
    ...
    def __init__(self, config: dict | None = None):
        ...
        self.spread_frac = float(cfg.get("spread_frac", 0.68))
        ...
        self.inv_pause_ticks = int(cfg.get("inv_pause_ticks", 10))
        ...
        self.pull_size_mult = float(cfg.get("pull_size_mult", 0.4))
