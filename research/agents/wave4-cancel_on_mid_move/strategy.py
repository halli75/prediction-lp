...
class Strategy:
    ...
    def __init__(self, config: dict | None = None):
        ...
        self.mid_move_cancel_cents = float(cfg.get("mid_move_cancel_cents", 3.0))
        # Extra widen multiplier when mid moved but below hard-cancel
        self.mid_move_widen_mult = float(cfg.get("mid_move_widen_mult", 1.6484714739089332))
        ...
        self.mid_move_hard_cancel_cents = float(cfg.get("mid_move_hard_cancel_cents", 3.5))
