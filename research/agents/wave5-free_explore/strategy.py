...
class Strategy:
    ...
    def __init__(self, config: dict | None = None):
        ...
        self.spread_frac = float(cfg.get("spread_frac", 0.6572324823769505))
        ...
        self.max_abs_inv = float(cfg.get("max_abs_inv", 80.0))
        ...
        self.near_mid_size_mult = float(cfg.get("near_mid_size_mult", 0.46022498756464164))
        ...
        self.pull_size_mult = float(cfg.get("pull_size_mult", 0.4994091461144214))
