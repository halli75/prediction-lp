...
class Strategy:
    ...
    def __init__(self, config: dict | None = None):
        ...
        self.spread_frac = float(cfg.get("spread_frac", 0.9321736106773362))
        # Inventory skew strength (price shift per share of net YES exposure) — stronger
        self.skew_bps_per_share = float(cfg.get("skew_bps_per_share", 0.16786385464952927))
        ...
        self.pull_size_mult = float(cfg.get("pull_size_mult", 0.6601798561109946))
