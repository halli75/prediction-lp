...
class Strategy:
    ...
    def __init__(self, config: dict | None = None):
        ...
        self.mid_move_widen_mult = float(cfg.get("mid_move_widen_mult", 1.8577011238306351))
        ...
        self.min_daily_reward_pool = float(cfg.get("min_daily_reward_pool", 150.0))
        ...
        self.mid_move_hard_cancel_cents = float(cfg.get("mid_move_hard_cancel_cents", 3.0))
