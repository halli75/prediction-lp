...
class Strategy:
    def __init__(self, config: dict | None = None):
        ...
        self.spread_frac = float(cfg.get("spread_frac", 0.3239964427354885))
        # Inventory skew strength (price shift per share of net YES exposure)
        self.skew_bps_per_share = float(cfg.get("skew_bps_per_share", 0.12565410450830355))
        # Target quote size as multiple of min_size
        self.size_mult = float(cfg.get("size_mult", 3.2917134140018542))
        ...
        self.inv_soft_cap = float(cfg.get("inv_soft_cap", 384.8538991073939))
        ...
        self.reward_spread_boost = float(cfg.get("reward_spread_boost", 0.2850796953770259))
